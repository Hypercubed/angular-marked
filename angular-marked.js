    ...
    .directive('marked', ['marked', '$templateRequest', '$compile', '$timeout', function (marked, $templateRequest, $compile, $timeout) {
        return {
            ...
            link: function (scope, element, attrs) {
                if (scope.enableCompilation == undefined) {
                    scope.enableCompilation = false;
                }
                ...
                function set(text) {
                    ...
                    // \r\n and ident is for the real text converting to markdown 
                    // but if user prepares text for markdown there shoud be \n\n according to marked documentation
                    // so extend unident function with \n\n or just leve it like it is in your code it is up to you
                    text = text.replace(/\\n\\n/, '\n\n');
